...
inquirer
   .prompt([
      ...
      {
         type: 'input',
         message: 'Describe the motivation of the project ',
         name: 'content',
      },
      {
         type: 'input',
         message: 'What are the Installation Steps? (Separate steps by comma) ',
         name: 'installation_steps',
      },
      {
         type: 'input',
         message: 'How is this software mean to be used? ',
         name: 'usage',
      },
      {
         type: 'list',
         message: 'Seleect your license ',
         name: 'license',
         choices: ["MIT", "GPL", "BSD", "Apache"],
      },
      {
         type: 'input',
         message: 'Who are contributing in the project? ',
         name: 'contributers',
      },
      {
         type: 'input',
   ...
   .then((answers) => {
      /////////////
      console.log(answers.installation_steps);
      const html_page = `# ${answers.title}
...
[![GitHub Streak](http://github-readme-streak-stats.herokuapp.com?user=${answers.username}&theme=dark&background=000000)](https://git.io/streak-stats)

[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=${answers.username}&layout=compact&theme=vision-friendly-dark)](https://github.com/anuraghazra/github-readme-stats)
...
## Email address: <a href = "mailto: ${answers.email}">${answers.email}</a>`;
      
      //////////// 
      fs.writeFile('README.md', html_page, 'ascii',
...
// function CreateInstallationSteps(steps) {
//    const array = steps.split(", ")
...
function badges(license) {
   if (license === "MIT") {
      ...
      return "![BSD](https://img.shields.io/badge/license-BSD-red)"
   }
   
   else if (license === "APACHE") {
      return "![APACHE](https://img.shields.io/badge/license-APACHE-yellowgreen)"
   }
}